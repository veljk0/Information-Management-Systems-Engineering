...
export default {
  ...
  methods: {
    ...
    soldTickets(){
      ...
      for (i = 0; i < this.myflights.length; i++) {
       for (j = 0; j < this.myflights[i].tickets.length; j++) {
         if(this.myflights[i].tickets[j].sold == false) this.companyTickets.push(this.myflights[i].tickets[j])
       }
      }
    ...
    this.companyTickets = [];
      ...
      for (i = 0; i < this.myflights.length; i++) {
       for (j = 0; j < this.myflights[i].tickets.length; j++) {
         if(this.myflights[i].tickets[j].sold == false) this.sum+= this.myflights[i].tickets[j].price
       }
      }
